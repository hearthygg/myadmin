...
declare type PersonalState = {
	...
	personalForm: UserForm;
	rolesOptions: Array<SelectOptionType>
	ugroupOptions: Array<SelectOptionType>
	sexOptions: Array<SelectOptionType>,
	dialog: {
		visable: boolean;
		title: string;
	}
...
declare type TableSearchType = {
	...
	required: boolean;
	type: string;
	state?: 'add' | 'edit' | undefined;
	options?: SelectOptionType[];
};

declare interface TableDemoState<T,Y> {
	tableData: {
		data: Y[];
		...
		config: {
			...
			isSerialNo: boolean;
			isOperate: boolean;
			operateBtn: Array<string>;
			operateWidth: string;
			rowId: string;
		};
		search: TableSearchType[];
		dialogForm: TableSearchType[];
		param: T;
	};
}
/**
 * 聊天消息队列
 */
declare interface ChatListItem {
	/**
	 * 类型
	 */
	type: string,
